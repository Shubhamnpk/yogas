export const contact = {
  ...
  ne: {
    ...
    subtitle: "तपाईंको लाम, तपाईंको डिपो, वा योग्यासबारे कुनै सोध छ? हामीलाई सुन्न चाहन्छौं।",
    email: "इमेल",
    emailBody: "हामीलाई इमेल पठाउनुहोस्, हामीले व्यवसाय दिनभित्रै जवाफ दिनेछौं।",
    phone: "फोन",
    phoneBody:
      "तलको नम्बरमा फोन गर्नुहोस्। कार्यालयको समय: बिहीबारदेखि आइतबारसम्म ९ बजेदेखि ५ बजेसम्म।",
    address: "ठेगाना",
    ...
    formHint:
      "यो तपाईंको इमेल एपमा पहिले नै भरिएको सन्देश सहित खोल्छ। हामीले अर्कोति नै जवाफ दिनेछौं।",
