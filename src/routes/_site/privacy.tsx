...
export const Route = createFileRoute("/_site/privacy")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "How we collect, use, and protect your information on YoGas.",
      },
    ],
  }),
      ...
      <div className="grid gap-8 lg:grid-cols-12 items-start">
            ...
            <div className="space-y-3 text-xs text-muted-foreground leading-relaxed">
              <div className="p-3 bg-secondary/50 rounded-xl border border-border/60">
                <p className="font-semibold text-foreground mb-1">
                  <Lock className="size-3.5 text-primary mr-1 inline-block" />
                  {lang === "ne" ? "सुरक्षित इन्क्रिप्सन" : "Secure Encryption"}
                </p>
                <p>
                  {lang === "ne"
                    ? "तपाईंको नागरिकता नम्बर डेटाबेस स्तरमा इन्क्रिप्ट गरिएको छ।"
                    : "Citizenship details are fully encrypted at rest and in transit."}
                </p>
              </div>
              <div className="p-3 bg-secondary/50 rounded-xl border border-border/60">
                <p className="font-semibold text-foreground mb-1">
                  <Ban className="size-3.5 text-primary mr-1 inline-block" />
                  {lang === "ne" ? "कुनै व्यावसायिक सेयरिङ छैन" : "No Third-Party Ads"}
                </p>
                <p>
                  {lang === "ne"
                    ? "हामी तपाईंको व्यक्तिगत डाटा कसैलाई बेच्दैनौं वा विज्ञापनका लागि साझा गर्दैनौं।"
                    : "We never sell or share your contact data for marketing purposes."}
                </p>
              </div>
              <div className="p-3 bg-secondary/50 rounded-xl border border-border/60">
                <p className="font-semibold text-foreground mb-1">
                  <Hourglass className="size-3.5 text-primary mr-1 inline-block" />
                  {lang === "ne" ? "डेटा मेटाउने अधिकार" : "Right to Erase"}
                </p>
                <p>
                  {lang === "ne"
                    ? "खाता हटाउँदा तपाईंको सबै जैविक विवरणहरू स्थायी रूपमा मेटिन्छन्।"
                    : "Your verification tokens are purged when you close your account."}
                </p>
              </div>
            </div>
          </div>
        ...
        <article className="lg:col-span-8 bg-card border border-border rounded-3xl p-6 md:p-10 shadow-soft prose prose-slate max-w-none dark:prose-invert">
          ...
          <div className="space-y-6 divide-y divide-border/40">
            <div className="pt-2">
              <h2 className="text-lg font-bold text-foreground mb-2" id="info">
            ...
            <div className="pt-6">
              <h2 className="text-lg font-bold text-foreground mb-2" id="citizenship">
            ...
            <div className="pt-6">
              <h2 className="text-lg font-bold text-foreground mb-2" id="retention">
            ...
            <div className="pt-6">
              <h2 className="text-lg font-bold text-foreground mb-2" id="rights">
            ...
            <div className="pt-6">
              <h2 className="text-lg font-bold text-foreground mb-2" id="third">
